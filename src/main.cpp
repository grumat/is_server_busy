...
static int Usage(const char *argv0)
{
	...
	std::cerr	<< path << std::endl
				...
				<< "    -c <config>           : specify a configuration file. Default to '/opt/local/etc/is_bjmm_server_busy.conf'.\n"
				<< "    -h, --help            : show help\n"
...
{
	std::string cfg = "/opt/local/etc/is_bjmm_server_busy.conf";
	std::string log_file;
	String log_level;
	int verbose = 0;
	...
	#define LogDebug()	if (log_debug_) Log(DEBUG)
